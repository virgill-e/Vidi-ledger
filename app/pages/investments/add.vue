<template>
  <div class="flex flex-col gap-6 lg:gap-10 min-w-0 mx-auto max-w-[800px] w-full pb-20">
    ...
    <div class="flex flex-col gap-2">
      ...
      <p class="text-text-body/60 font-medium">Saisissez les détails de cet investissement (achat, vente ou dividende).</p>
    </div>
...
const handleSubmit = async () => {
  ...
  if (form.type === 'sell' && currentHolding.value !== null && form.quantity !== undefined && form.quantity > currentHolding.value) return;
